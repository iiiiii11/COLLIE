...
class SafexpEnvBase:
    ...
    def copy(self, name='', config={}):
        ...
        return SafexpEnvBase(self.name + name, new_config, prefix=self.prefix)
...
bench_base = SafexpEnvBase('',
                           {'observe_goal_lidar': True,
                            ...
                            'lidar_max_dist': 3,
                            'lidar_num_bins': 16,
                            'randomize_layout': False,  # fix the layout
                            'continue_goal': False,  # no second goal, a done will be induced when meet the goal
                            },
                           prefix='CSafe')
